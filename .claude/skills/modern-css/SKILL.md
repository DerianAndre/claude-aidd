...
name: modern-css
description: >-
  Modern CSS features and best practices for building interfaces with pure
  native CSS — no preprocessors, no frameworks.
...
- **Frontend rules**: [rules/frontend.md](../../rules/frontend.md) (WCAG 2.1 AA, responsive design, component patterns)
- **Design architect**: [agents/design-architect](../../agents/design-architect) (design systems, design tokens)
- **Performance**: [rules/performance.md](../../rules/performance.md) (frontend performance budgets, Core Web Vitals)
