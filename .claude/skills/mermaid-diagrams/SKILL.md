...
description: >-
  Generate Mermaid diagrams in markdown. Visual representations of code, systems,
  processes, data structures, database schemas, workflows, or API flows.
...
- **Deliverables**: [rules/deliverables.md](../../rules/deliverables.md) (diagram deliverable requirement for non-trivial features)
- **Documentation**: [rules/documentation.md](../../rules/documentation.md) (normalized document pattern, Mermaid in docs)
- **System architect**: [agents/system-architect](../../agents/system-architect) (C4 diagrams, system design)
