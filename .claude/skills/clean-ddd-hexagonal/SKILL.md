...
- **Enforcement rules**: [rules/backend.md](../../rules/backend.md) (hexagonal architecture enforcement, layer separation, database patterns)
- **Architecture audit**: [/architecture-audit](../architecture-audit/SKILL.md) (DDD/hexagonal purity verification)
- **Testing patterns**: [rules/testing.md](../../rules/testing.md) (coverage targets per layer, AAA pattern)
- **Code style**: [rules/code-style.md](../../rules/code-style.md) (naming conventions, immutability constraints)
- **Security**: [rules/security.md](../../rules/security.md) (OWASP compliance for domain services)
