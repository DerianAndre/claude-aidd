...
description: >-
  Feature-Sliced Design (FSD) architecture for frontend projects. Strict layer
  hierarchy and import rules for scalable, maintainable applications.
...
triggers:
  ...
  - layer hierarchy
  - public API pattern
  - shared/entities/features/widgets/pages/app layers
---
...
- **Frontend rules**: [rules/frontend.md](../../rules/frontend.md) (React patterns, component architecture, accessibility)
- **Code style**: [rules/code-style.md](../../rules/code-style.md) (import patterns, directory structure)
- **Experience engineer**: [agents/experience-engineer](../../agents/experience-engineer) (frontend architecture, state management)
