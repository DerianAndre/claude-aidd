...
description: >-
  Modern JavaScript (ES6-ES2025) patterns and best practices. Immutability,
  functional patterns, async, and expressive syntax.
...
- **Code style**: [rules/code-style.md](../../rules/code-style.md) (naming conventions, import patterns, TypeScript standards)
- **Version protocol**: [rules/version-protocol.md](../../rules/version-protocol.md) (verify ES version support before using features)
- **Testing**: [rules/testing.md](../../rules/testing.md) (test patterns for modern JS features)
